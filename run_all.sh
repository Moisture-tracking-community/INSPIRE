...
jupyter nbconvert --execute --to notebook --inplace Figure2_Global_map.ipynb
...
jupyter nbconvert --execute --to notebook --inplace Figure6_Clustering.ipynb
jupyter nbconvert --execute --to notebook --inplace Figure7_Correlation_matrix.ipynb
#jupyter nbconvert --execute --to notebook --inplace Table3_barplots_all_cases.ipynb